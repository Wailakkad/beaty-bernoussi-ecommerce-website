...
export default function Checkout() {
  ...
  onMouseEnter={(e) => {
    if (!isSubmitting && cart.length > 0) {
      e.currentTarget.style.background = 'linear-gradient(to right, rgb(31 41 55), rgb(0 0 0))';
    }
  }}
  onMouseLeave={(e) => {
    if (!isSubmitting && cart.length > 0) {
      e.currentTarget.style.background = 'linear-gradient(to right, rgb(0 0 0), rgb(31 41 55))';
    }
  }}
>
  {isSubmitting ? (
